## train
python -m torch.distributed.run --nproc_per_node=2 train_retrieval_lora.py --lora=0 --is_train=1 --distributed=1 --eval_on=both
## test 
python train_retrieval_lora.py --evaluate --lora=0 --is_train=0 --distributed=0 --eval_on=test --pretrained=output/Retrieval_coco/checkpoint_best.pth
