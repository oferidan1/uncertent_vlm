...
class BLIP_Retrieval(nn.Module):
    ...
    def forward(self, image, caption, alpha, idx):
        ...
        if self.is_itc_only:    
            return loss_ita, torch.tensor(0.0, device=image.device)  # return 0 for itm loss if itc only
    ...
    def encode_image(self, image):
        ...
        image_embed = self.vision_proj(image_feat[:,0,:])            
